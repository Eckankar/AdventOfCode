...
parseInput = do
    ...
    let fixedRooms = map makeRoom $ zip3 fixedAmphipods roomOwners fixedRoomCoords
    return $ M.fromList $ hallway ++ initialRooms ++ fixedRooms
        where exits = S.fromList [3,5,7,9]
              ...
              roomCoords = [(2,3),(2,5),(2,7),(2,9),(5,3),(5,5),(5,7),(5,9)]
              fixedRoomCoords = [(3,3),(3,5),(3,7),(3,9),(4,3),(4,5),(4,7),(4,9)]
              fixedAmphipods = map parseAmphipod "DCBADBAC"
